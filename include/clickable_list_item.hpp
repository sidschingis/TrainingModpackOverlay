...
public:
  ...
  void setClickListener(std::function<void(const std::vector<std::string>, int*, std::string, int index, std::string title, std::string help)> clickListener) { this->m_clickListener = clickListener; }
  void setHelpListener(std::function<void(std::string, std::string)> helpListener) { this->m_helpListener = helpListener; }

private:
  const std::vector<std::string> m_values;
  int* m_curValue;
  std::function<void(const std::vector<std::string>, int*, std::string, int, std::string, std::string)> m_clickListener = nullptr;
